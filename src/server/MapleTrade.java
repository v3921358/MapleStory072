...
public class MapleTrade {
    ...
    public final void CompleteTrade() {
        ...
        if (this.exchangeMeso > 0) {
            this.chr.get().gainMeso(this.exchangeMeso - GameConstants.getTaxAmount(this.exchangeMeso), false, false, false);
        }
        this.exchangeMeso = 0;
    ...
    public final void cancel(MapleClient c, MapleCharacter chr, int unsuccessful) {
        ...
        if (this.meso > 0) {
            chr.gainMeso(this.meso, false, false, false);
        }
        this.meso = 0;
    ...
    public final void setMeso(int meso) {
        ...
        if (this.chr.get().getMeso() >= meso) {
            this.chr.get().gainMeso(-meso, false, false, false);
            this.meso += meso;
