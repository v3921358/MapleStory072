...
public class CSPacket {
    ...
    private static final byte Operation_Code = 44;//0x2C
    ...
    public static byte[] warpCS(MapleClient c) {
        ...
        for (CashModInfo cm : cmi) {
            ...
            if (cm.sn == 20800004 || cm.sn == 20800005 || cm.sn == 20800006 || cm.sn == 20800007 || cm.sn == 30000029 || cm.sn == 30000031 || cm.sn == 30000033
                    || cm.sn == 50400051
                    || cm.sn == 20800158
                    || cm.sn == 20900026 || cm.sn == 20900031 || cm.sn == 20900032 || cm.sn == 20900033 || cm.sn == 20900061 || cm.sn == 20900062 || cm.sn == 20900063 || cm.sn == 20900066 || cm.sn == 20900072 || cm.sn == 20900073) {
                mplew.writeInt(0x404);//Flags
                //if ((flags & 0x4) != 0) {
                mplew.writeInt(cm.discountPrice);
                //}
                //if ((flags & 0x400) != 0) {
        ...
        //PacketHelper.sub_9551FE(mplew, c);
...
//    }
    ...
    public static byte[] confirmFromCSInventory(Item item, short pos) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(Operation_Code + 30); //+0x1E
...
//    }
    public static byte[] confirmToCSInventory(Item item, int accId, int sn) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(Operation_Code + 32);//+0x20
        addCashItemInfo(mplew, item, accId, sn, false);
//        System.out.println("string " + mplew.toString());
        return mplew.getPacket();
    }
