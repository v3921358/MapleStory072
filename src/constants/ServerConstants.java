...
public class ServerConstants {
    ...
    public static final String MAIN_WORLD = "MapleStory72";
    public static byte MAPLE_LOCAL = TESPIA ? (byte) 5 : (byte) 4;
    public static final byte[] Gateway_IP = ServerConfig.Business ? (new byte[]{(byte) 61, (byte) 160, (byte) 247, (byte) 81}) : (new byte[]{(byte) 127, (byte) 0, (byte) 0, (byte) 1});
