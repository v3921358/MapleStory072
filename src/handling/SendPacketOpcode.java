...
public enum SendPacketOpcode implements WritableIntValueHolder {
    ...
    //许可协议
    LICENSE_RESULT((short) 0x01),
    //选择性别
    CHOOSE_GENDER((short) 0x02),
    //性别选择返回
    GENDER_SET((short) 0x03),
    //服务器状态
    SERVERSTATUS((short) 0x04),
    //服务器列表
    SERVERLIST((short) 0x06),
    //人物列表
    CHARLIST((short) 0x07),
    //服务器IP
    SERVER_IP((short) 0x08),
    //检查人物名字
    CHAR_NAME_RESPONSE((short) 0x09),
    //注册帐号窗口
    REGISTER_INFO((byte) 0x0A),
    //检查帐号名是否可用
    CHECK_ACCOUNT_INFO((byte) 0x0B),
    //注册帐号
    REGISTER_ACCOUNT((byte) 0x0C),
    //创建人物
    ADD_NEW_CHAR_ENTRY((short) 0x0E),
    //删除角色
    DELETE_CHAR_RESPONSE((byte) 0x0F),
    //更换频道
    ...
    CS_USE((short) 0x12),
    //道具栏信息
    INVENTORY_OPERATION((short) 0x1A),
    //更新道具栏数量
    INVENTORY_GROW((short) 0x1B),
    //刷新人物属性
    UPDATE_STATS((short) 0x1C),
    //获得增益效果状态
    GIVE_BUFF((short) 0x1D),
    //取消增益效果状态
    CANCEL_BUFF((short) 0x1E),
    //临时能力值开始
    TEMP_STATS((short) 0x1F),
    //临时能力值结束
    TEMP_STATS_RESET((short) 0x20),
    //刷新技能
    ...
    //小纸条
    SHOW_NOTES((short) 0x25),
    //缩地石
    TROCK_LOCATIONS((short) 0x26),
    //测谎仪
    LIE_DETECTOR((short) 0x27),
    //刷新骑宠
    UPDATE_MOUNT((short) 0x2C),
    //任务提示
    SHOW_QUEST_COMPLETION((short) 0x2D),
    //雇佣商店
    SEND_TITLE_BOX((short) 0x2E),
    //使用技能书
    USE_SKILL_BOOK((short) 0x2F),
    //道具排序
    FINISH_SORT((short) 0x30),
    //道具集合
    FINISH_GATHER((short) 0x31),
    //角色信息
    CHAR_INFO((short) 0x34),
    //开设组队
    PARTY_OPERATION((short) 0x35),
    //好友列表
    BUDDYLIST((short) 0x36),
    //家族操作
    GUILD_OPERATION((short) 0x38),
    //家族联盟
    ALLIANCE_OPERATION((short) 0x39),
    //召唤门
    SPAWN_PORTAL((short) 0x3A),
    //服务器公告
    SERVERMESSAGE((short) 0x3B),
    //花生机奖励
    PIGMI_REWARD((short) 0x3C),
    //商店搜索器
    OWL_OF_MINERVA((short) 0x3D),
    //商店搜索传送
    OWL_RESULT((short) 0x3E),
    //
    ENGAGE_REQUEST((short) 0x3F),
    //
    ENGAGE_RESULT((short) 0x40),
    //红鸾宫结婚滚动特效条
    MARRAGE_EFFECT((short) 0x41),
    //黄色文字
    YELLOW_CHAT((short) 0x48),
    //捕捉怪物文字
    CATCH_MOB((short) 0x4A),//77
    //情景喇叭重置 -7
    AVATAR_MEGA_RESULT((short) 0x4E),
    //情景喇叭 -7
    AVATAR_MEGA((short) 0x4F),
    //情景喇叭删除 -7
    AVATAR_MEGA_REMOVE((short) 0x50),
    //建立玩家Npc -7
    MAKE_PLAYER_NPC((short) 0x51),
    //玩家NPC
    PLAYER_NPC((short) 0x52),
    GET_CARD((short) 0x53),
    MONSTERBOOK_CHANGE_COVER((short) 0x54),
    //未知
    SESSION_VALUE((short) 0x59),
    //打开校谱
    SEND_PEDIGREE((short) 0x5A),
    //打开学院
    OPEN_FAMILY((short) 0x5C),
    //学院返回信息
    FAMILY_MESSAGE((short) 0x5D),
    //学院邀请
    FAMILY_INVITE((short) 0x5E),
    //接受(拒绝)学院邀请 
    FAMILY_JUNIOR((short) 0x5F),
    //学院信息
    SENIOR_MESSAGE((short) 0x60),
    //学院系统
    FAMILY((short) 0x61),
    //改变学院点数
    REP_INCREASE((short) 0x62),
    //学院玩家登录
    FAMILY_LOGGEDIN((short) 0x63),
    //学院状态
    FAMILY_BUFF((short) 0x64),
    //使用学院点
    FAMILY_USE_REQUEST((short) 0x65),
    //学院等级提升信息
    LEVEL_UPDATE((short) 0x67),
    //
    MARRIAGE_UPDATE((short) 0x68),
    //
    TOP_MSG((short) 0x999),
    //钓鱼
    FISHING_BOARD_UPDATE((short) 0x6D),
    //技能宏 -12
    SKILL_MACRO((short) 0x6E),
    //传送到地图 -12
    WARP_TO_MAP((short) 0x6F),
    //打开拍卖
    MTS_OPEN((short) 0x70),
    //打开商城 -12
    CS_OPEN((short) 0x71),
    //重置屏幕
    RESET_SCREEN((short) 0x72),
    //地图错误
    MAP_BLOCKED((short) 0x73),
    //服务器错误
    SERVER_BLOCKED((short) 0x74),
    //组队提示错误
    PARTY_BLOCKED((short) 0x75),
    //显示装备效果
    SHOW_EQUIP_EFFECT((short) 0x76),
    //组队家族聊天 -13
    MULTICHAT((short) 0x77),
    //悄悄话
    WHISPER((short) 0x78),
    //配偶聊天
    SPOUSE_CHAT((short) 0x79),
    //BOSS血条
    BOSS_ENV((short) 0x7A),
    //
    MOVE_ENV((short) 0x7B),
    //更新BOSS血条
    UPDATE_ENV((short) 0x7C),
    //地图效果 
    MAP_EFFECT((short) 0x7B),
    //音乐盒 5100000
    CASH_SONG((short) 0x7C),
    //GM效果 
    GM_EFFECT((short) 0x7F),
    //0X问答活动 
    OX_QUIZ((short) 0x7E),
    //0X问答提示 
    GMEVENT_INSTRUCTIONS((short) 0x7F),
    //时钟 
    CLOCK((short) 0x80),
    //船只特效
    BOAT_EFFECT((short) 0x82),
    //船只移动
    BOAT_MOVE((short) 0x83),
    //船只状态
    BOAT_STATE((short) 0x84),
    //
    SET_OBJECT_STATE((short) 0x85),
    //时间停止
    STOP_CLOCK((short) 0x86),
    //阿里安特记分板
    ARIANT_SCOREBOARD((short) 0x88),//12F
    //召唤玩家 -18
    SPAWN_PLAYER((short) 0x8A),
    //召唤玩家 -18
    REMOVE_PLAYER_FROM_MAP((short) 0x8B),
    //聊天信息
    CHATTEXT((short) 0x8C),
    //小黑板
    CHALKBOARD((short) 0x8D),
    //更新玩家
    UPDATE_CHAR_BOX((short) 0x8E),
    //消費效果
    SHOW_CONSUME_EFFECT((short) 0x8F),
    //砸卷效果
    SHOW_SCROLL_EFFECT((short) 0x90),
    //钓鱼
    FISHING_CAUGHT((short) 0x92),
    //召唤宠物
    SPAWN_PET((short) 0x94),
    //宠物移动
    MOVE_PET((short) 0x96),
    //PET_CHAT
    PET_CHAT((short) 0x97),
    //宠物名变更
    PET_NAMECHANGE((short) 0x98),
    //宠物例外道具
    PET_EXCEPTION_LIST((short) 0x99),
    //宠物命令
    PET_COMMAND((short) 0x9A),
    //召唤兽召唤
    SPAWN_SUMMON((short) 0x9B),
    //召唤兽移除
    REMOVE_SUMMON((short) 0x9C),
    //召唤兽移动
    MOVE_SUMMON((short) 0x9D),
    //召唤兽攻击
    SUMMON_ATTACK((short) 0x9E),
    //召唤兽技能
    SUMMON_SKILL((short) 0x9F),
    //召唤兽受到伤害
    DAMAGE_SUMMON((short) 0xA0),
    //人物移动
    MOVE_PLAYER((short) 0xA2),
    //近距离攻击 
    CLOSE_RANGE_ATTACK((short) 0xA3),
    //远距离攻击 
    RANGED_ATTACK((short) 0xA4),
    //魔法攻击 
    MAGIC_ATTACK((short) 0xA5),
    //被动攻击 
    ENERGY_ATTACK((short) 0xA6),
    //技能能效果
    SKILL_EFFECT((short) 0xA7),
    //取消技能效果
    CANCEL_SKILL_EFFECT((short) 0xA8),
    //人物伤害
    DAMAGE_PLAYER((short) 0xA9),
    //人物面部表情
    FACIAL_EXPRESSION((short) 0xAA),
    //显示物品效果
    SHOW_EFFECT((short) 0xAC),
    //椅子效果
    SHOW_CHAIR((short) 0xAD),
    //更新玩家外观
    UPDATE_CHAR_LOOK((short) 0xAE),
    //玩家外观效果
    SHOW_FOREIGN_EFFECT((short) 0xAF),
    //获取异常状态
    GIVE_FOREIGN_BUFF((short) 0xB0),
    //取消异常状态
    CANCEL_FOREIGN_BUFF((short) 0xB1),
    //更新组队HP显示
    UPDATE_PARTYMEMBER_HP((short) 0xB2),
    //加载家族名字 
    LOAD_GUILD_NAME((short) 0xB3),
    //加载家族图标 
    LOAD_GUILD_ICON((short) 0xB4),
    //加载团队
    LOAD_TEAM((short) 0xB5),
    //取消椅子
    CANCEL_CHAIR((short) 0xB6),
    //显示物品效果
    SHOW_SPECIAL_EFFECT((short) 0xB7),
    //角色地图瞬移 武林道场会出现
    CURRENT_MAP_WARP((short) 0xB8),
    //使用金币包成功
    MESOBAG_SUCCESS((short) 0xBB),
    //使用金币包失败 
    MESOBAG_FAILURE((short) 0xBC),
    //刷新任务
    UPDATE_QUEST_INFO((short) 0xBD),
    //未知
    HP_DECREASE((short) 0xBE),
    //增加(取消)宠物技能 
    PET_FLAG_CHANGE((short) 0xBF),
    //玩家提示
    PLAYER_HINT((short) 0xC0),
    //技能冷却
    COOLDOWN((short) 0xCD),
    //召唤怪物 -1F
    SPAWN_MONSTER((short) 0xCF),
    //杀死怪物 -1F
    KILL_MONSTER((short) 0xD0),
    //召唤怪物控制 -1F
    SPAWN_MONSTER_CONTROL((short) 0xD1),
    //怪物移动 -1F
    MOVE_MONSTER((short) 0xD2),
    //移动怪物回应 -1F
    MOVE_MONSTER_RESPONSE((short) 0xD3),
    //添加怪物状态
    APPLY_MONSTER_STATUS((short) 0xD5),
    //取消怪物状态
    CANCEL_MONSTER_STATUS((short) 0xD6),
    //怪物攻击怪物
    MOB_TO_MOB_DAMAGE((short) 0xD7),
    //怪物伤害
    DAMAGE_MONSTER((short) 0xD9),
    //显示怪物HP -1F
    SHOW_MONSTER_HP((short) 0xDD),
    //显示磁铁(显示蓝色CATCH)
    SHOW_MAGNET((short) 0xDE),
    //抓怪物(显示红色CATCH)
    CATCH_MONSTER((short) 0xE0),
    //更新到这里

    //召唤NPC -21
    SPAWN_NPC((short) 0xE3),
    //移除NPC -21
    REMOVE_NPC((short) 0xE4),
    //唤NPC 请求控制权 -21
    SPAWN_NPC_REQUEST_CONTROLLER((short) 0xE5),
    //NPC说话
    NPC_ACTION((short) 0xE6),
    //召唤雇佣商店
    SPAWN_HIRED_MERCHANT((short) 0xEC),
    //取消雇佣商店 
    DESTROY_HIRED_MERCHANT((short) 0xED),
    //更新雇佣商店
    UPDATE_HIRED_MERCHANT((short) 0xEE),
    //掉落物品在地图上 -21
    DROP_ITEM_FROM_MAPOBJECT((short) 0xEF),
    //从地图上删除物品 -21
    REMOVE_ITEM_FROM_MAP((short) 0xF0),
    //召唤LOVE错误
    SPAWN_KITE_ERROR((short) 0xF1),
    //召唤LOVE
    SPAWN_KITE((short) 0xF2),
    //取消LOVE
    DESTROY_KITE((short) 0xF3),
    //召唤烟雾
    SPAWN_MIST((short) 0xF4),
    //取消烟雾
    REMOVE_MIST((short) 0xF5),
    //召唤门
    SPAWN_DOOR((short) 0xF6),
    //取消门
    REMOVE_DOOR((short) 0xF7),
    //攻击反应堆
    REACTOR_HIT((short) 0xFB),
    //反应堆移动
    REACTOR_MOVE((short) 0xFC),
    //召唤反应堆
    REACTOR_SPAWN((short) 0xFD),
    //移除反应堆
    REACTOR_DESTROY((short) 0xFE),
    //怪物嘉年华
    MONSTER_CARNIVAL_START((short) 0x108),//2C9
    MONSTER_CARNIVAL_OBTAINED_CP((short) 0x109),//2CA
    MONSTER_CARNIVAL_PARTY_CP((short) 0x10A),
    MONSTER_CARNIVAL_SUMMON((short) 0x10B),//2CD
    MONSTER_CARNIVAL_DIED((short) 0x10D),//2CF
    MONSTER_CARNIVAL_LEAVE((short) 0x10E),//2D0
    MONSTER_CARNIVAL_RESULT((short) 0x110),//2D1
    //阿里安特排行更新
    ARIANT_SCORE_UPDATE((short) 0x111),
    //NPC交谈 -0x25
    NPC_TALK((short) 0x120),
    //打开NPC商店
    OPEN_NPC_SHOP((short) 0x121),
    //NPC商店确认
    CONFIRM_SHOP_TRANSACTION((short) 0x122),
    //打开仓库
    OPEN_STORAGE((short) 0x125),
    //聊天招待
    MERCH_ITEM_MSG((short) 0x126),
    //弗兰德里
    MERCH_ITEM_STORE((short) 0x127),
    //剪刀石头布
    RPS_GAME((short) 0x128),
    //聊天招待
    MESSENGER((short) 0x129),
    //玩家互动
    PLAYER_INTERACTION((short) 0x12A),
    // 抽奖提示
    TIP_BEANS((short) 0x136),
    //打开豆豆机界面
    OPEN_BEANS((short) 0x137),
    // 豆豆机发射
    SHOOT_BEANS((short) 0x138),
    //送货员 -0x26
    PACKAGE_OPERATION((short) 0x139),
    //商城刷新点卷
    CS_UPDATE((short) 0x13B),
    //商城操作 
    CS_OPERATION((short) 0x13C),
    //键盘排序 -0x2A
    KEYMAP((short) 0x145),
    //宠物自动补红
    PET_AUTO_HP((short) 0x146),
    //宠物自动补蓝
    PET_AUTO_MP((short) 0x147),
    // General
    ...
    INTRO_LOCK((short) 0x999),//1FE
    INTRO_ENABLE_UI((short) 0x210),//1FF
    INTRO_DISABLE_UI((short) 0x999),//200
    SUMMON_HINT((short) 0x212),//201
    SUMMON_HINT_MSG((short) 0x213),//202
    ...
    ROLL_SNOWBALL((short) 0xFF),//2C7
    HIT_SNOWBALL((short) 0x100),
    SNOWBALL_MESSAGE((short) 0X101),
    LEFT_KNOCK_BACK((short) 0X102),
    HIT_COCONUT((short) 0x103),
    COCONUT_SCORE((short) 0x104),
